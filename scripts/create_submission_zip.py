import zipfile
files = [
    'output/skynet-nidhi-prayas-deck-polished.pptx',
...
with zipfile.ZipFile('output/skynet-nidhi-prayas-submission.zip','w',zipfile.ZIP_DEFLATED) as z:
    for f in files:
        z.write(f)
print('Created output/skynet-nidhi-prayas-submission.zip')
